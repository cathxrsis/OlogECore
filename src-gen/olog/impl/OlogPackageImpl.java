 ...
 * @generated
 */
public class OlogPackageImpl extends EPackageImpl implements OlogPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see olog.OlogPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OlogPackageImpl() {
		super(eNS_URI, OlogFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link OlogPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static OlogPackage init() {
		if (isInited)
			return (OlogPackage) EPackage.Registry.INSTANCE.getEPackage(OlogPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredOlogPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		OlogPackageImpl theOlogPackage = registeredOlogPackage instanceof OlogPackageImpl
				? (OlogPackageImpl) registeredOlogPackage
				: new OlogPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theOlogPackage.createPackageContents();

		// Initialize created meta-data
		theOlogPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theOlogPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(OlogPackage.eNS_URI, theOlogPackage);
		return theOlogPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getArrow_From() {
	 ...
	 * @generated
	 */
	public EAttribute getArrow_Description() {
		return (EAttribute) arrowEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public OlogFactory getOlogFactory() {
		return (OlogFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(arrowEClass, ARROW__FROM);
		createEReference(arrowEClass, ARROW__TO);
		createEAttribute(arrowEClass, ARROW__DESCRIPTION);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getCategory_Category(), this.getCategory(), null, "category", null, 0, -1, Category.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(objectEClass, olog.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getObject_Name(), ecorePackage.getEString(), "name", null, 0, 1, olog.Object.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getObject_Description(), ecorePackage.getEString(), "description", null, 0, 1, olog.Object.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getArrow_Name(), ecorePackage.getEString(), "name", null, 0, 1, Arrow.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArrow_From(), this.getObject(), null, "from", null, 1, 1, Arrow.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getArrow_To(), this.getObject(), null, "to", null, 1, 1, Arrow.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getArrow_Description(), ecorePackage.getEString(), "description", null, 0, 1, Arrow.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
